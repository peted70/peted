...
excerpt: "This time around we were looking to render glass containers with associated labelling which needed to be clear and legible and the glass should look as realistic as possible in the available time..."
header:
    teaserlogo: 'assets/images/2017/04/bottles.png'
    teaser: 'assets/images/2017/04/bottles.png'
---
Since composing the last post: <a title="{{site.baseurl}}/hololens/unity/2017/03/19/hololensthe-path-to-60fps.html" href="{{site.baseurl}}/hololens/unity/2017/03/19/hololensthe-path-to-60fps.html" target="_blank" rel="noopener">HoloLens–The Path to 60fps</a> I have carried out some more work on HoloLens apps with an important requirement for as high quality rendering as possible but of course the goal is always to maintain 60 frames per second. This time around we were looking to render glass containers with associated labelling which needed to be clear and legible and the glass should look as realistic as possible in the available time.
...
<a href="{{ site.baseurl }}/assets/images/2017/04/image.png"><img style="background-image: none; padding-top: 0px; padding-left: 0px; display: inline; padding-right: 0px; border-width: 0px;" title="image" src="{{ site.baseurl }}/assets/images/2017/04/image_thumb.png" alt="image" width="733" height="694" border="0" /></a>
...
<a href="{{ site.baseurl }}/assets/images/2017/04/devportal.png"><img style="background-image: none; padding-top: 0px; padding-left: 0px; display: inline; padding-right: 0px; border-width: 0px;" title="devportal" src="{{ site.baseurl }}/assets/images/2017/04/devportal_thumb.png" alt="devportal" width="723" height="561" border="0" /></a>
...
<a href="{{ site.baseurl }}/assets/images/2017/04/shadersettings1.png"><img style="background-image: none; padding-top: 0px; padding-left: 0px; display: inline; padding-right: 0px; border-width: 0px;" title="shadersettings1" src="{{ site.baseurl }}/assets/images/2017/04/shadersettings1_thumb.png" alt="shadersettings1" width="739" height="442" border="0" /></a>

The shader gives control over the highlights and also the alpha blending modes:
<h3><a href="{{ site.baseurl }}/assets/images/2017/04/shadersettings2.png"><img style="background-image: none; padding-top: 0px; padding-left: 0px; display: inline; padding-right: 0px; border-width: 0px;" title="shadersettings2" src="{{ site.baseurl }}/assets/images/2017/04/shadersettings2_thumb.png" alt="shadersettings2" width="741" height="250" border="0" /></a></h3>
<a href="{{ site.baseurl }}/assets/images/2017/04/bottles.png"><img style="background-image: none; padding-top: 0px; padding-left: 0px; display: inline; padding-right: 0px; border-width: 0px;" title="bottles" src="{{ site.baseurl }}/assets/images/2017/04/bottles_thumb.png" alt="bottles" width="736" height="410" border="0" /></a>
<h3>Normal Maps</h3>
&nbsp;
...
<a href="{{ site.baseurl }}/assets/images/2017/04/clip_image0017.png"><img style="background-image: none; padding-top: 0px; padding-left: 0px; display: inline; padding-right: 0px; border-width: 0px;" title="clip_image001[7]" src="{{ site.baseurl }}/assets/images/2017/04/clip_image0017_thumb.png" alt="clip_image001[7]" width="748" height="481" border="0" /></a>
...
<a href="{{ site.baseurl }}/assets/images/2017/04/cap.png"><img style="background-image: none; padding-top: 0px; padding-left: 0px; display: inline; padding-right: 0px; border-width: 0px;" title="cap" src="{{ site.baseurl }}/assets/images/2017/04/cap_thumb.png" alt="cap" width="737" height="453" border="0" /></a>
...
<a href="{{ site.baseurl }}/assets/images/2017/04/removeduplicates.png"><img style="background-image: none; padding-top: 0px; padding-left: 0px; display: inline; padding-right: 0px; border-width: 0px;" title="removeduplicates" src="{{ site.baseurl }}/assets/images/2017/04/removeduplicates_thumb.png" alt="removeduplicates" width="730" height="403" border="0" /></a>

This took the number of faces down to about 11k

<a href="{{ site.baseurl }}/assets/images/2017/04/afterremoveduplicates.png"><img style="background-image: none; padding-top: 0px; padding-left: 0px; display: inline; padding-right: 0px; border-width: 0px;" title="afterremoveduplicates" src="{{ site.baseurl }}/assets/images/2017/04/afterremoveduplicates_thumb.png" alt="afterremoveduplicates" width="729" height="354" border="0" /></a>
...
<a href="{{ site.baseurl }}/assets/images/2017/04/createnormalmapsettings.png"><img style="background-image: none; padding-top: 0px; padding-left: 0px; display: inline; padding-right: 0px; border-width: 0px;" title="createnormalmapsettings" src="{{ site.baseurl }}/assets/images/2017/04/createnormalmapsettings_thumb.png" alt="createnormalmapsettings" width="722" height="770" border="0" /></a>
...
<a href="{{ site.baseurl }}/assets/images/2017/04/normalmap.png"><img style="background-image: none; padding-top: 0px; padding-left: 0px; display: inline; padding-right: 0px; border-width: 0px;" title="normalmap" src="{{ site.baseurl }}/assets/images/2017/04/normalmap_thumb.png" alt="normalmap" width="739" height="497" border="0" /></a>
...
<a href="{{ site.baseurl }}/assets/images/2017/04/textureotnormalmap.png"><img style="background-image: none; padding-top: 0px; padding-left: 0px; display: inline; padding-right: 0px; border-width: 0px;" title="textureotnormalmap" src="{{ site.baseurl }}/assets/images/2017/04/textureotnormalmap_thumb.png" alt="textureotnormalmap" width="723" height="990" border="0" /></a>

Change the influence setting for the texture from diffuse rgb to normal

<a href="{{ site.baseurl }}/assets/images/2017/04/caps.png"><img style="background-image: none; padding-top: 0px; padding-left: 0px; display: inline; padding-right: 0px; border-width: 0px;" title="caps" src="{{ site.baseurl }}/assets/images/2017/04/caps_thumb.png" alt="caps" width="732" height="499" border="0" /></a>
